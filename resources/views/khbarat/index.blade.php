...
<div class=" container-fluid container-fixed-lg p-t-50">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 sm-no-padding">
                ...
                <a href="{{ url('khbarat/1') }}" class="text-black">
                    <div id="card-advance" class="card card-default">
                        <div class="card-body"> 
                            ...
                            <h5><strong>Harhoura, Plage de Témara</strong></h5>
                        ...
                        <div class="comment-up">
                            ...
                            <div class="text-center">
                                <a href="{{ url('khbarat/1') }}"><i class="fa fa-comments"></i>  Voir tout les comment(522)</a>
                            </div>
